 ...
 * @author Siyuan He
 */
public class FenwayPanel extends javax.swing.JPanel {

    /**
     * Creates new form Fenway
     */
    private Systems sys;
    private ArrayList<Person> fenwayPerson = new ArrayList<>();
    private ArrayList<Person> patients = new ArrayList<>();

    public FenwayPanel(Systems sys) {
        initComponents();
        this.sys = sys;
        fenwayPerson = new ArrayList<>();
        filterFenway();
        filterFenwayPatient();
        populatePerson();
        txtPatient.setText(String.valueOf(patients.size()));
        txtPerson.setText(String.valueOf(fenwayPerson.size()));
    ...
    private void filterFenway() {
        for (Person p : sys.getPersonDirectory().getPersons()) {
            if (p.getCommunity().getName().equalsIgnoreCase("Fenway")) {
                fenwayPerson.add(p);
            }
        }
        System.out.println("**" + fenwayPerson);
    }
    ...
    private void filterFenwayPatient() {
